  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-10">
      <div className="w-full max-w-lg p-6 bg-white shadow-xl rounded-lg">
        <h2 className="text-2xl font-semibold text-center text-purple-950 mb-5">Comment Section</h2>
        ...
        <div className="mb-4">
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-950 transition-all"
          />
        </div>
        ...
        <button
          ...
          className="w-full bg-purple-700 text-white p-3 rounded-md hover:bg-purple-950 transition-all"
        >
          Post Comment
        </button>
      </div>
          ...
          {comments.map((commentData, index) => (
            ...
            >
              <div className="flex justify-between items-center">
                <p className="font-bold text-purple-950">{commentData.username}:</p>
                <button
